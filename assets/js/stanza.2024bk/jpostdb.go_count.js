...
jpostdb.go_count = jpostdb.go_count || {
	...
	var url = jpostdb.api + "proteins_go_count?" + param.apiArg.join("&") + "&category=" + param.category;
	...
	var showProteinList = function(id){
	    var url = jpostdb.api + "protein_with_go_term?" + param.apiArg.join("&") + "&category=" + param.category + "&term=" + id;
