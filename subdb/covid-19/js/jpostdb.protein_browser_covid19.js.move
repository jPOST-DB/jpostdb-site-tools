...
jpostdb.protein_browser = jpostdb.protein_browser || {
	...
	var url = "https://sparql-support.dbcls.jp/tmp/dev/corona/json/" + stanza_params.uniprot + ".json";
	...
	group.mouseEvent(svg, setData, plot);
      ...
      var url = "https://sparql-support.dbcls.jp/tmp/dev/corona/json/" + param.dataset + "_" + param.uniprot + ".json";
